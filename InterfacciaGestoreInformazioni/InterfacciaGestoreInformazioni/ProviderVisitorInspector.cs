...
namespace WindowsFormsApplication1
{
    class ProviderVisitorInspector
    {
        ...
        public List<Type> GetVisitorFromFile(string fileName) //prendi da file piu' aggiornamento dinamico
        {
            return GetTypeFromFile(fileName,interfaceVisitor);
        }

        public List<Type> GetProviderFromFile(string fileName) //prendi da file piu' aggiornamento dinamico
        {
